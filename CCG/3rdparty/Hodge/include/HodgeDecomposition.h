 ...
 *   Hodge Decomposition
 */
class EXPORTIT CHodgeDecomposition
{
  public:
    /*!
    ...
    */
    ...
    void integration(CHodgeDecompositionMesh* pForm);
  ...
  protected:
    ...
    */
    void _calculate_dual_edge_length();
    /*!
    *   compute face area
    */
    void _calculate_face_area();
    /*!
    *   compute dual vertex area
    */
    void _calculate_dual_vertex_area();
